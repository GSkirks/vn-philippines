...
if (isset($_POST['add-submit'])) {
  ...
  if ($result == TRUE) {
    echo("<script>window.location = '14daypaymethod.php';</script>");
      exit();
    }else{
      echo 'error';
    }
    ...
    <div class="form">
     ...
     <div class="inputfield">
      ...
      <div class="inputfield">
          ...
          <input type="text" value="14-Day Nutrition Plan" name="pscode" class="input" readonly>
       </div> 
